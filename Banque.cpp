...
Banque::Banque(string id, double soldeInitial, string rib) { // constructeur
...
string Banque::getRIB() {
    return rib;
}

void Banque::Crediter() { // CREDITER LE COMPTE
    system("CLS");
    cout << "\n\tCRÉDITER\n\n";
...
void Banque::Debiter() { // DEBITER LE COMPTE
    system("CLS");
    cout << "\n\tDÉBITER\n\n";
